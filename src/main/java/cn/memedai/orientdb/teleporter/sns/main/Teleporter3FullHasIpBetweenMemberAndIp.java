 ...
 * </pre>
 */
public class Teleporter3FullHasIpBetweenMemberAndIp extends Teleporter {

    private static final Logger LOGGER = LoggerFactory.getLogger(Teleporter3FullHasIpBetweenMemberAndIp.class);
...
//        submit(HasApplyConsumer.class);
        ...
        submit(HasIpBetweenMemberAndIpConsumer.class);
