...
import cn.memedai.orientdb.teleporter.sns.consumer.vertex.ApplyInfoConsumer;
import cn.memedai.orientdb.teleporter.sns.producer.increment.ApplyInfoIncrementProducer;
 ...
 * </pre>
 */
public class Teleporter3FullHasDeviceBetweenMemberAndDevice extends Teleporter {

    private static final Logger LOGGER = LoggerFactory.getLogger(Teleporter3FullHasDeviceBetweenMemberAndDevice.class);
...
//        submit(HasApplyConsumer.class);
        ...
        submit(HasDeviceBetweenMemberAndDeviceConsumer.class);
