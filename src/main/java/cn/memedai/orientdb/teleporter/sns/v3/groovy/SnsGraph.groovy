...
try {
    ...
    config.attributes = ['Phone0'         : ['modularity_class': '当前手机号', 'symbol': 'image://resources/images/phone0.png', 'symbolSize': 30, 'itemStyle': blackItemStyle, 'isLegend': true, 'showLegendIfHasHugeData': true],//当前查询手机号
                         'Phone1'         : ['modularity_class': '一度手机号', 'symbol': 'image://resources/images/phone1.png', 'symbolSize': 15, 'itemStyle': blackItemStyle, 'isLegend': true, 'showLegendIfHasHugeData': false],//一度联系人手机号
                         'Phone2'         : ['modularity_class': '二度手机号', 'symbol': 'image://resources/images/phone2.png', 'symbolSize': 15, 'itemStyle': blackItemStyle, 'isLegend': true, 'showLegendIfHasHugeData': false],//二度联系人手机号
                         'Member0'        : ['modularity_class': '当前会员', 'symbol': 'image://resources/images/member0.png', 'symbolSize': 30, 'itemStyle': blackItemStyle, 'isLegend': true, 'showLegendIfHasHugeData': true],//当前查询会员
                         'Member0_overdue': ['modularity_class': '当前会员', 'symbol': 'image://resources/images/member_overdue.png', 'symbolSize': 30, 'itemStyle': blackItemStyle, 'isLegend': true, 'showLegendIfHasHugeData': true],//当前查询会员
                         'Member'         : ['modularity_class': '会员', 'symbol': 'image://resources/images/member.png', 'symbolSize': 15, 'itemStyle': blackItemStyle, 'isLegend': true, 'showLegendIfHasHugeData': false],
                         'Member_overdue' : ['modularity_class': '会员', 'symbol': 'image://resources/images/member_overdue.png', 'symbolSize': 15, 'itemStyle': blackItemStyle, 'isLegend': true, 'showLegendIfHasHugeData': false],//逾期会员
                         'Applynull'      : ['modularity_class': '申请', 'symbol': 'image://resources/images/apply.png', 'symbolSize': 15, 'itemStyle': blackItemStyle, 'isLegend': true, 'showLegendIfHasHugeData': false],//默认申请
                         'Apply1'         : ['modularity_class': '申请', 'symbol': 'image://resources/images/apply1.png', 'symbolSize': 15, 'itemStyle': blackItemStyle, 'isLegend': false, 'showLegendIfHasHugeData': false],//申请过件
                         'Apply0'         : ['modularity_class': '申请', 'symbol': 'image://resources/images/apply0.png', 'symbolSize': 15, 'itemStyle': blackItemStyle, 'isLegend': false, 'showLegendIfHasHugeData': false],//申请拒件
                         'Order1'         : ['modularity_class': '订单', 'symbol': 'image://resources/images/order1.png', 'symbolSize': 15, 'itemStyle': blackItemStyle, 'isLegend': false, 'showLegendIfHasHugeData': false],//订单过件
                         'Ordernull'      : ['modularity_class': '订单', 'symbol': 'image://resources/images/order0.png', 'symbolSize': 15, 'itemStyle': blackItemStyle, 'isLegend': false, 'showLegendIfHasHugeData': false],//订单拒件
                         'Order0'         : ['modularity_class': '订单', 'symbol': 'image://resources/images/order.png', 'symbolSize': 15, 'itemStyle': blackItemStyle, 'isLegend': true, 'showLegendIfHasHugeData': false],//默认订单
                         'Device'         : ['modularity_class': '设备ID', 'symbol': 'image://resources/images/device.png', 'symbolSize': 15, 'itemStyle': blackItemStyle, 'isLegend': true, 'showLegendIfHasHugeData': true],
                         'IP'             : ['modularity_class': 'IP', 'symbol': 'image://resources/images/ip.png', 'symbolSize': 15, 'itemStyle': blackItemStyle, 'isLegend': true, 'showLegendIfHasHugeData': true]
    ]
