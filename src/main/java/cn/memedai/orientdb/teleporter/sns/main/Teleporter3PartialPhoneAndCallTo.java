 ...
 * </pre>
 */
public class Teleporter3PartialPhoneAndCallTo extends Teleporter {

    private static final Logger LOGGER = LoggerFactory.getLogger(Teleporter3PartialPhoneAndCallTo.class);
